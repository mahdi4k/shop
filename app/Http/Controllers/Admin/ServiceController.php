...
class ServiceController extends Controller
{
    ...
    {
        return View('Admin.service.create',['product'=>$this->product]);
    }
    ...
    public function edit($id)
    {
        ...
        return View('Admin.service.edit',['service'=>$service,'product'=>$this->product]);
    }
    ...
    {
        $service=Service::findOrFail($id);
        return view('Admin.service.show',['product'=>$this->product,'service'=>$service]);
    }
    ...
    public function get_price(Request $request)
    {
        ...
        return View('Admin.service.add_price',['product_color'=>$product_color,
