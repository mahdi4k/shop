...
@section('content')
    <div class="box_title">
        ...
        <a class="btn btn-danger" href="/admin/product">بازگشن</a>
    </div>
    ...
    @if(sizeof($image)>0)
        ...
        <div id="show_product_image">
            <p class="text-center font-weight-bold">تصویر شاخص</p>
    ...
    <div id="image_product_box">
        <p class="text-center font-weight-bold">تصاویر محصول</p>
