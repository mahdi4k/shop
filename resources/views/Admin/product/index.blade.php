...
@section('content')
    ...
    <div>
        <a style="margin-bottom: 20px" href="{{ url('admin/product/create') }}" class="btn btn-success">افزودن محصول</a>
...
<?php
            ...
            <td><p><a target="_blank" href="{{ url('product').'/'.$value['code_url'].'/'.$value['title_url'] }}">{{ $value['title'] }}</a></p>
