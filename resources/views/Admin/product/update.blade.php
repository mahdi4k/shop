...
@section('content')
    ...
    <div class="form-group">
        ...
        <input type="text" name="tag_list" id="tag_list" class="form-control" style=" width:60%;">
        <div style="margin-top: 5px" class="btn btn-outline-primary add_product_tag" onclick="add_tag()">افزودن</div>
