    ...
    <div style="width:95%;margin:50px auto">
        ...
        <form action="{{ url('Payment') }}" method="post">
                        ...
                        <div class="d-flex justify-content-around">
                            ...
                            <div class="radio-control first_pay_div " id="pay_radio_2" onclick="set_pay(2)">
                                <label for="post_radio_2">
                                    <img width="50" height="50" alt="bank_meli" src="{{url('img/bank_meli.jpeg')}}">

                                </label>
                                <em></em>
                                <span style="font-size:15px" class="d-block">درگاه پرداخت اینترنتی بانک ملی</span>
                            ...
                            <div class="radio-control2 custom-style-payment"  id="pay_radio_3" onclick="set_pay(3)">
                                <label>
                                    <img width="50"  alt="bank_meli" src="{{url('img/download (1).jpeg')}}">
                                </label>
                                <em></em>
                                <span style="font-size:15px" class="d-block">درگاه پرداخت اینترنتی بانک ملت</span>
                            ...
                            <div class="radio-control" id="pay_radio_4" onclick="set_pay(4)">
                                <label>
                                    <img width="50" alt="bank_meli" src="{{url('img/zarin_pal.jpeg')}}">
                                </label>
                                 <em></em>
                                <span style="font-size:15px" class="d-block">درگاه پرداخت اینترنتی زرین پال</span>
            ...
            <div class="d-flex justify-content-center btn-fixed">
                    <input type="submit" value="پرداخت و ثبت نهایی سفارش" class="btn pull-left btn-info-custom-payment hvr-sweep-to-left" type="submit">  
             </div>
