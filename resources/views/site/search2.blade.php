    ...
    <div class="row" id="filter_product_box">
        ...
        <div class="col-md-3">
            ...
            <div class="filter_box">
                ...
                <div style="background:white;border-bottom: 1px solid #E3E3E3;padding:30px 15px 20px 15px;cursor:pointer">
        ...
        <div class="col-md-9 show_product">
            ...
            <div style="padding-top:15px;width:97%;float:right;background:white;display:flex;border-radius:12px">
                ...
                <ul class="search_type_ul">
                    ...
                    <li style="position: absolute;left: 24px;top: 15px;">
