        ...
        <div style="width:95%;margin:50px auto">
            ...
            <div class="order_item_price">
                ...
                <div>
                    ...
                    <span style="float:left">{{ arabic_w2e( number_format($total_price)) }} تومان</span>
                </div>
                ...
                <div>
                    <span>تخفیف</span>
                    <span style="float:left">{{ arabic_w2e( number_format($total_price-$price)) }} تومان</span>
                </div>

                <div style="background:#FCF5F5;color:#FF6B6B">
                    <span>مبلغ قابل پرداخت</span>
                    <span style="float:left">{{ arabic_w2e( number_format($price+$price2)) }} تومان</span>
                </div>
            ...
            <table class="order_location_data">
                ...
                <tr>
                    ...
                    <td>
                        @if($order_type==1)
                            <span>اين سفارش از طريق تحويل اکسپرس  با هزينه 10,000 تومان به شما تحويل داده خواهد شد.</span>
                        @else
                            <span>
