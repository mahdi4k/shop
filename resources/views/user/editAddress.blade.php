...
<div id="address_table_<?= $value->id ?>" class="  user_address @if($key==0) active_address @endif">
    ...
    <div class="ostan-address">
        <span class="ml-3" style="color: #9e8585;font-size: 19px;"><i class="fa fa-map-marker"></i></span>
    ...
    <div class="callNumber-adress">
        <span class="ml-3" style="color: #9e8585;font-size: 19px;"><i class="fa fa-phone" aria-hidden="true"></i></span>
